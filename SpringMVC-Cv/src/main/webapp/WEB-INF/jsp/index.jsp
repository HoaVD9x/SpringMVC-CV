        ...
        <div class="container">
            ...
            <div class="row" data-aos="fade-in">
                ...
                <div class="col-lg-7 mt-5 mt-lg-0 d-flex align-items-stretch">
                    <form:form action="${pageContext.request.contextPath}/contact" modelAttribute="contact" method="post" role="form" cssClass="php-email-form">
                        <div class="row">
                        ...
                        <div class="form-group">
                            ...
                            <form:textarea path="message" class="form-control" name="message" rows="10" />
                        </div>
                        </spring:bind>
                        <div class="my-3">
                        ...
                        <div class="text-center"><form:button type="submit">Send Message</form:button></div>
                    </form:form>
                </div>
